...
int main(){
    ...
    do{
        ...
        case 1: 
            ...
            fprintf(disciplinas,"Código da diciplina: %d\nNome da disciplina: %s\n", nova.codigo, nova.nomedisc);
            fclose(disciplinas);
