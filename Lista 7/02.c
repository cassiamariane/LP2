...
int main(){
    ...
    do{
        ...
        case 1: 
            ...
            disciplinas = fopen("disciplinas.dat", "wb");
            ...
            fwrite(&nova, sizeof(nova), 1, disciplinas);
            fclose(disciplinas);
        ...
        case 2:
            ...
            fwrite(&nova, sizeof(nova), 1, alunos);
            fclose(alunos);
        ...
        case 4:
            ...
            for(int i = 0; i < 40; i++){
                while(fgets(arqtext, 100, alunos) != NULL){
                    fread(&nova, sizeof(nova), 1, alunos);
                }
            };
        ...
        case 6:
            ...
            boletins = fopen("boletins.dat", "rb");
            ...
            fwrite(&nova, sizeof(nova), 1, boletins);

            for(int i = 0; i < 40; i++){
                while(fgets(arqtext, 100, boletins) != NULL){
                    fread(&nova, sizeof(nova), 1, boletins);
                }
            };
